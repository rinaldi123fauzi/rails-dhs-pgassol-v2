Rails.application.routes.draw do
  resources :products do
    get :new_modalbox, on: :collection
  end
  resources :types do
    get :new_modalbox, on: :collection
  end
  post 'import_items/create'
  ...
  get 'import_items/update'

  get 'import_items/destroy'

  resources :item_price_letters
  resources :delivery_items
  resources :detail_items
  resources :price_items do
    collection do
      get 'new2/:items_id' => :new2, as: 'new2'
    end
  end
  resources :referensi_items
  resources :items do
    get :import, on: :collection
    get :getDataTemplate, on: :collection
    delete :destroy_multiple, on: :collection
  end
  resources :user_activities
  resources :disiplines do
    get :new_modalbox, on: :collection
    collection do
      get 'edit_modalbox/:id' => :edit_modalbox, as: 'edit_modalbox'
    end
  end
  resources :indonesia_villages
  resources :indonesia_districts
  resources :indonesia_cities
  resources :indonesia_provinces
  resources :vendors do
    get :new_modalbox, on: :collection
    collection do
      get 'detail_modalbox/:id' => :detail_modalbox, as: 'detail_modalbox'
    end
  end
  resources :currencies
  resources :references
  resources :price_letters do
    collection do
      get 'downloadLetter/:price_letter_id' => :downloadLetter, as: 'downloadLetter'
    end
  end
  resources :units do
    get :new_modalbox, on: :collection
  ...
  resources :brochures do
    collection do
      get 'new2/:items_id' => :new2, as: 'new2'
      get 'downloadBrochure/:brochure_id' => :downloadBrochure, as: 'downloadBrochure'
    end
  end
  resources :countries
  resources :brands do
  ...
  root 'dashboard#items_home'
  resources :dashboard do
    collection do
      get 'items_table/:disipline_id' => :items_table, as: 'items_table'
      get 'items_show/:id' => :items_show, as: 'items_show'
      get 'getItemsData/:type_id' => :getItemsData, as: 'getItemsData'
    end
    get :items_search, on: :collection
  end
