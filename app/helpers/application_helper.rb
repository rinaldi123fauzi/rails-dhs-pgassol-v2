...
module ApplicationHelper
  ...
  def getYear
    if Time.current.year >= 2020
      date = "2019 - " + "#{Time.now.year}"
    else
      date = Time.current.year
    end
    return date
  end

  def setLogActivity(activity)
    @getRole = RoleAssignment.left_outer_joins(:role).where(user_id: current_user.id).select('*')
    UserActivity.create! user_name: current_user.username,
                         role: @getRole.first.name.to_s,
  ...
  def left_menu
    if current_user.roles.any? { |r| r.name == "Superadmin" }
      # left_menu_entries(setLeftMenuSuperadmin + left_menu_content)
      left_menu_entries(setHomePage + setLeftMenuSuperadmin)
    else
      left_menu_entries(setHomePage)
    end
  end
  ...
  def setLeftMenuSuperadmin
    [
        {
            href: '#',
            title: _('Admin Panel'),
            content: "<i class='fa fa-lg fa-fw fa-user'></i> <span class='menu-item-parent'>" + _('Admin Panel') + "</span>",
            children:
                [
                    {
                        href: '#',
                        title: _('User Management'),
                        content: "<i class='fa fa-lg fa-fw fa-cog'></i> <span class='menu-item-parent'>" + _('User Management') + "</span>",
                        children: [
                            {
                                href: roles_path,
                                title: _('Roles'),
                            ...
                            },
                            {
                                href: users_path,
                                title: _('Users'),
                                content: "<span class='menu-item-parent'>" + _('Users') + "</span>"
                            },
                        ]
                    },
                    {
                        href: '#',
                        title: _('Data Master'),
                        content: "<i class='fa fa-lg fa-fw fa-cog'></i> <span class='menu-item-parent'>" + _('Data Master') + "</span>",
                        children: [
                            {
                                href: countries_path,
                                title: _('Countries'),
                                content: "<span class='menu-item-parent'>" + _('Countries') + "</span>"
                            },
                            {
                                href: units_path,
                                title: _('Units'),
                                content: "<span class='menu-item-parent'>" + _('Units') + "</span>"
                            },
                            {
                                href: vendors_path,
                                title: _('Vendors'),
                                content: "<span class='menu-item-parent'>" + _('Vendors') + "</span>"
                            },
                            {
                                href: brochures_path,
                                title: _('Brochures'),
                                content: "<span class='menu-item-parent'>" + _('Brochure') + "</span>"
                            },
                            {
                                href: price_letters_path,
                                title: _('Price Letters'),
                                content: "<span class='menu-item-parent'>" + _('Price Letters') + "</span>"
                            },
                        ]
                    },
                    {
                        href: '#',
                        title: _('Item Management'),
                        content: "<i class='fa fa-lg fa-fw fa-cog'></i> <span class='menu-item-parent'>" + _('Item Management') + "</span>",
                        children: [
                            {
                                href: referensi_items_path,
                                title: _('References'),
                                content: "<span class='menu-item-parent'>" + _('References') + "</span>"
                            },
                            {
                                href: disiplines_path,
                                title: _('Disiplines'),
                                content: "<span class='menu-item-parent'>" + _('Disiplines') + "</span>"
                            },
                            {
                                href: brands_path,
                                title: _('Brands'),
                                content: "<span class='menu-item-parent'>" + _('Brands') + "</span>"
                            },
                            {
                                href: items_path,
                                title: _('Items'),
                                content: "<span class='menu-item-parent'>" + _('Items') + "</span>"
                            },
                            {
                                href: price_items_path,
                                title: _('Price Items'),
                                content: "<span class='menu-item-parent'>" + _('Price Items') + "</span>"
                            },
                            {
                                href: types_path,
                                title: _('Types'),
                                content: "<span class='menu-item-parent'>" + _('Types') + "</span>"
                            },
                        ]
                    },
                    {
                        href: user_activities_path,
                        title: _('User Activities'),
                        content: "<span class='menu-item-parent'>" + _('User Activities') + "</span>"
                    }
                ]
        }
    ]
  ...
  def getDataCountry
    @d ||= Country.all
    @d.each do |f|
      @countries_name = f.country_name
      @data = [{
                   href: "#",
                   title: _(@countries_name),
                   content: "<span class='menu-item-parent'>" + _(@countries_name) + "</span>"
               },
               {
                   href: "#",
                   title: _(@countries_name),
    ...
    [
        {
            href: '#',
            title: _('Looping'),
            content: "<i class='fa fa-lg fa-fw fa-cog'></i> <span class='menu-item-parent'>" + _('Looping') + "</span>",
            children: getDataCountry
        }
    ]
  end
